...
export default function ProjectsPage() {
  ...
  async function handleShareProject(project: Project) {
    const url = new URL(
      localizedPath(lang, `projects/editor?id=${encodeURIComponent(project.id)}`),
      ...
      <div className="mx-auto w-full max-w-7xl px-4 py-10 sm:px-6 sm:py-14 lg:px-8">
        <div className="mb-8 flex flex-col gap-6">
          ...
          <div className="grid w-full grid-cols-1 gap-2 sm:grid-cols-2 xl:grid-cols-4">
            ...
            <Button
              render={<Link href={localizedPath(lang, "projects/new")} />}
          ...
          <Card className="border-[#e9e5fb] bg-white/80 shadow-[0_18px_45px_rgba(88,67,166,0.08)]">
            <CardContent className="flex flex-col items-center p-10 text-center sm:p-16">
              ...
              <p className="mt-5 max-w-md text-sm leading-6 text-[#777592]">
                ...
                <Link href={localizedPath(lang, "projects/new")} className="font-semibold text-[#6f45dc] underline decoration-[#cfc0ff] underline-offset-4 hover:text-[#4c27ba]">
                  {t("projects.new")}
                </Link>
...
function ProjectCard({
  ...
  return (
      ...
      <CardContent className="mt-auto flex items-center justify-between gap-2 px-5 pb-5">
        <Button
          render={<Link href={localizedPath(lang, `projects/editor?id=${project.id}`)} />}
          size="sm"
