---
title: "How to Create a Comic Character Reference Sheet"
seoTitle: "How to Create a Comic Character Reference Sheet | GenStory.cc"
description: "A practical step-by-step guide to create a comic character reference sheet, with prompts, review checks, and links to related GenStory.cc guidance."
slug: "how-to-create-character-reference-sheet"
route: "/en/guides/comic/how-to-create-character-reference-sheet"
locale: en
contentType: guide
category: "comic"
related:
  - "/en/guides/ai/how-to-keep-character-consistent-across-images"
  - "/en/guides/comic/how-to-write-comic-image-prompts"
draft: false
---

# How to Create a Comic Character Reference Sheet

A practical step-by-step guide to create a comic character reference sheet, with prompts, review checks, and links to related GenStory.cc guidance.
...
### 1. Choose page or vertical format, reading direction, and length
...
### 2. Convert prose into visible story beats

Define the input, expected result, and acceptance check for this step. Record confirmed decisions, unresolved questions, and any change that could affect connected content before moving on.

### 3. Plan page turns, panels, and information density

Define the input, expected result, and acceptance check for this step. Record confirmed decisions, unresolved questions, and any change that could affect connected content before moving on.

### 4. Create stable character, location, and prop references

Define the input, expected result, and acceptance check for this step. Record confirmed decisions, unresolved questions, and any change that could affect connected content before moving on.

### 5. Write one auditable image prompt and dialogue note per panel

Define the input, expected result, and acceptance check for this step. Record confirmed decisions, unresolved questions, and any change that could affect connected content before moving on.

### 6. Review thumbnails for reading order and continuity
...
```text
Help me with this task: How to Create a Comic Character Reference Sheet.
...
- [/en/guides/ai/how-to-keep-character-consistent-across-images](/en/guides/ai/how-to-keep-character-consistent-across-images)
- [/en/guides/comic/how-to-write-comic-image-prompts](/en/guides/comic/how-to-write-comic-image-prompts)
