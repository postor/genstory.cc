...
const zh: Dict = {
  ...
  "projects.importConflictTitle": "发现已有作品，是否覆盖？",
  "projects.importConflictDescription":
    "备份中有 {count} 个作品与当前浏览器中的作品使用相同 ID。确认后会覆盖这些作品的本地文件和项目记录，其他作品会继续导入。",
  "projects.importConflictList": "将覆盖：",
  "projects.importConflictMore": "另有 {count} 个作品。",
  "projects.importConflictConfirm": "覆盖并导入",
  "projects.export": "导出",
  "projects.delete": "删除",
  "projects.open": "打开",
  "projects.share": "分享",
  "projects.shareText": "分享作品《{title}》",
  "projects.shareCopied": "已复制作品编辑链接",
  "projects.shareUnsupported": "当前浏览器不支持分享或复制链接。",
  "projects.more": "更多操作",
...
const en: Dict = {
  ...
  "projects.importConflictTitle": "Existing works found. Overwrite them?",
  "projects.importConflictDescription":
    "The backup contains {count} works with IDs already used in this browser. Confirming replaces their local files and project records; other works will still be imported.",
  "projects.importConflictList": "Works to overwrite:",
  "projects.importConflictMore": "{count} more works.",
  "projects.importConflictConfirm": "Overwrite and import",
  "projects.export": "Export",
  "projects.delete": "Delete",
  "projects.open": "Open",
  "projects.share": "Share",
  "projects.shareText": "Share “{title}”",
  "projects.shareCopied": "Project editor link copied",
  "projects.shareUnsupported": "This browser cannot share or copy the editor link.",
