...
const zh: Dict = {
  ...
  "projects.cloudDownloading": "正在下载文件 {completed}/{total}",
  "projects.cloudComparing": "正在比较文件内容…",
  "projects.cloudWriting": "正在写入本地文件 {completed}/{total}",
  "projects.cloudUploading": "正在上传文件 {completed}/{total}",
  "projects.cloudUpload": "上传到云盘",
  "projects.cloudDownload": "从云盘下载并合并",
  "projects.cloudUploadProject": "上传此作品",
  "projects.cloudDownloadProject": "下载并合并此作品",
  "projects.cloudSync": "先下载合并，再上传",
  "projects.cloudUploadTitle": "覆盖云盘中的同名文件？",
  "projects.cloudUploadDescription": "将上传当前浏览器中的作品。云盘中相同相对路径的文件会被覆盖，云盘里其他文件不会删除。",
  "projects.cloudUploadProjectDescription": "将只上传此作品的文件。云盘中此作品相同相对路径的文件会被覆盖，其他作品和其他云端文件不会删除。",
  "projects.cloudUploadConfirm": "覆盖同名文件并上传",
  "projects.cloudDownloadTitle": "合并云盘文件到本地？",
  "projects.cloudDownloadDescription": "将新增云盘文件并合并到本地。发现 {count} 个文件内容不一致；继续后这些文件会覆盖本地同路径文件，本地多出的文件不会删除。",
  "projects.cloudDownloadNoConflict": "云盘文件与本地内容没有冲突，确认后会写入新增文件。",
  "projects.cloudDownloadProjectDescription": "将只下载并合并此作品在云盘中的文件。发现 {count} 个文件内容不一致；继续后这些文件会覆盖本地同路径文件，本地多出的文件不会删除。",
  "projects.cloudDownloadProjectNoConflict": "此作品的云盘文件与本地内容没有冲突，确认后会写入新增文件。",
  "projects.cloudDownloadConfirm": "合并并覆盖冲突",
  "projects.cloudSyncTitle": "先合并云盘，再覆盖上传？",
  "projects.cloudSyncDescription": "同步会先把云盘冲突文件写入本地，再上传合并后的工作区。上传时相同相对路径的云盘文件也会被覆盖。",
  "projects.cloudSyncConfirm": "合并后覆盖上传",
  "projects.cloudConflictPreview": "将被覆盖的本地文件示例：",
  "projects.cloudConflictMore": "另有 {count} 个冲突文件。",
  "projects.cloudUploadConflictCount": "本次上传会覆盖云盘中的 {count} 个同名文件。",
  "projects.cloudNoProjects": "当前没有可同步的本地作品。",
  "projects.cloudSuccessUpload": "已上传到云盘",
  "projects.cloudSuccessDownload": "已从云盘合并到本地",
  "projects.cloudSuccessUploadProject": "已上传《{title}》到云盘",
  "projects.cloudSuccessDownloadProject": "已从云盘合并《{title}》",
  "projects.cloudSuccessSync": "已合并云盘内容并重新上传",
...
const en: Dict = {
  ...
  "projects.cloudDownloading": "Downloading files {completed}/{total}",
  "projects.cloudComparing": "Comparing file contents…",
  "projects.cloudWriting": "Writing local files {completed}/{total}",
  "projects.cloudUploading": "Uploading files {completed}/{total}",
  "projects.cloudUpload": "Upload to cloud drive",
  "projects.cloudDownload": "Download and merge from cloud",
  "projects.cloudUploadProject": "Upload this work",
  "projects.cloudDownloadProject": "Download this work",
  "projects.cloudSync": "Download, merge, then upload",
  ...
  "projects.cloudSyncTitle": "Merge cloud files, then overwrite upload?",
  "projects.cloudSyncDescription": "Sync first writes cloud conflicts into this browser, then uploads the merged workspace. Same relative paths in the cloud will be replaced.",
  "projects.cloudSyncConfirm": "Merge and overwrite upload",
  ...
  "projects.cloudSuccessSync": "Merged cloud files and uploaded again",
