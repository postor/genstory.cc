...
const zh: Dict = {
  ...
  "projects.storageNote":
    "作品内容和素材保存在这台设备的浏览器中，不会自动上传到 GenStory 服务器。换设备或清理浏览器数据前，请先备份。",
...
const en: Dict = {
  ...
  "projects.storageNote":
    "Your work and assets stay in this browser on this device and are not automatically uploaded to GenStory servers. Back up before changing devices or clearing browser data.",
