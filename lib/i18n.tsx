...
const zh: Dict = {
  ...
  "editor.toolReadFileDesc": "读取当前 GenStory.cc 项目中的单个文本文件完整内容。只在确实需要文件内容时调用。",
...
const en: Dict = {
  ...
  "editor.toolReadFileDesc": "Read the full content of one text file in the current GenStory.cc project. Use only when file content is actually needed.",
