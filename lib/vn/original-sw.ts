/**
 * Original OpenWebGal engine service worker (webgal-engine@4.6.2).
 * Used when exporting the standalone game zip so the bridge SW (which only
 * serves preview game files from IndexedDB) is NOT shipped to a disk deploy.
 */
export const ORIGINAL_SW = `const CACHE_PREFIX = 'webgal-';
